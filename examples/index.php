...
//         'examples' => [
//             ['151', 'Basic Physics', 'Create a basic physics-enabled scene.', ['Physics', 'Havok']],
//             ['152', 'Havok Physics Initialization', 'Initialize Havok physics through the runtime.', ['Physics', 'Havok']],
//             ['153', 'Physics Shape Type', 'Configure a physics shape type.', ['Physics']],
//             ['154', 'Physics Options', 'Configure physics aggregate options.', ['Physics', 'Properties']],
//             ['155', 'Static Body', 'Create a static physics body.', ['Physics', 'Body']],
//             ['156', 'Dynamic Body', 'Create a dynamic physics body.', ['Physics', 'Body']],
//             ['157', 'Kinematic Body', 'Create a kinematic physics body.', ['Physics', 'Body']],
//             ['158', 'Linear Velocity', 'Apply linear velocity to a physics body.', ['Physics', 'Velocity']],
//             ['159', 'Angular Velocity', 'Apply angular velocity to a physics body.', ['Physics', 'Velocity']],
//             ['160', 'Impulse', 'Apply an impulse to a physics body.', ['Physics', 'Impulse']],
//             ['161', 'Force', 'Apply a force to a physics body.', ['Physics', 'Force']],
//             ['162', 'Contact Position', 'Apply physics forces and impulses at a contact position.', ['Physics', 'Contact']],
//             ['163', 'Motion Type', 'Control physics body motion type.', ['Physics', 'Body']],
//             ['164', 'Collision Start', 'Handle collision start events.', ['Physics', 'Collision']],
//             ['165', 'Collision End', 'Handle collision end events.', ['Physics', 'Collision']],
//             ['166', 'Multiple Collision Types', 'Configure multiple collision event types.', ['Physics', 'Collision']],
//             ['167', 'Multiple Physics Objects', 'Create multiple physics-enabled objects.', ['Physics', 'Multiple']],
//             ['168', 'Physics + Meshes', 'Combine physics with runtime meshes.', ['Physics', 'Mesh']],
//             ['169', 'Physics + Models', 'Combine physics with loaded models.', ['Physics', 'Models']],
//             ['170', 'Physics + Actions', 'Connect physics events to runtime actions.', ['Physics', 'Actions']],
//             ['171', 'Advanced Physics Scene', 'Build a complete advanced physics scene.', ['Physics', 'Havok', 'Advanced']],
//         ],
//     ],
//     [
//         'number' => '13',
